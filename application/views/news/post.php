      ...
      <div class="item" id="news_<?=$query->news_id?>">
        ...
        <div class="content">
          ...
          <div class="description">
            <p>
              <?=substr($query->content,0,155);?>
              <a href="postview/<?php echo $query->news_id;?>">[...]</a>
            </p>
          </div>
          <div class="extra">
            <i><small>Posted at</small> <?=$query->date?></i>
            <a href="<?php echo site_url('postview/' . $query->news_id );?>" class="ui right float inverted green button" id="more">See more</a>
