    ...
    <div class="column row news">
        <div class="eight wide column">
            <div class="ui teal segment" id="news_<?=$query->news_id;?>">
                <div class="ui grid">
                        <input type="text"  hidden="hidden" class="news_id" value="<?=$query->news_id;?>" id="news_id" name="news_id">
                        <input type="text"  hidden="hidden" value="<?php echo $this->aauth->get_user_id($email=false);?>" id="id">
